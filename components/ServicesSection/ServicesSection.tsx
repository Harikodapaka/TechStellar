...
import { IconRouteSquare, IconCode, IconUsersGroup, IconCloudNetwork, IconBug, IconSpeakerphone } from '@tabler/icons-react';
import {
    Badge,
    Card,
    Container,
    ...
    return (
        <Container size="lg" py="xl">
            ...
            <Text c="dimmed" className={classes.description} ta="center" mt="md">
                We offer a comprehensive range of IT consulting services designed to meet the unique needs of businesses across various industries. At TechStellar, we are committed to helping your business leverage technology to achieve strategic objectives. Whether you're looking to optimize, our team is here to guide you every step of the way.
            </Text>
