import { IconBuildingSkyscraper, IconHistoryToggle, IconTargetArrow } from '@tabler/icons-react';

export const values = [
  {
    title: 'Our History',
    text: "Founded in 2022, TechStellar started as a small team passionate about empowering businesses with technology. Today, we're a trusted IT consulting leader, known for innovation, reliability, and client-focused solutions.",
